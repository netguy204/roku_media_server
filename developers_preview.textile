---
layout: default
title: "MyMedia: Developer's Installation Method"
branch: channel
---
...
# "Download":http://www.python.org/download and install python for your platform
# "Download MyMedia":https://github.com/netguy204/roku_media_server/zipball/channel
# Put your Roku into developer mode
# "Run springboard":#springboard to install the channel on your Roku and start the server
...
h2. Put your Roku into developer mode
...
h2(#springboard). Run springboard.py to install...

Run the automated client/server installation tool.

h2. Linux

pre. cd installation_dir/server
...
pre. Start | Programs | Python | IDLE
Menu: File | Open
...
h2. All Users:  Configuration Options
